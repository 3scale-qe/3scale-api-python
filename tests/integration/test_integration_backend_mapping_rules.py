...
def test_should_mapping_rule_endpoint_return_ok(service, backend_mapping_rule, backendservice, apicast_http_client):
...
def test_should_update_mapping_rule(service, backend, backendservice, updated_backend_mapping_rules_params, apicast_http_client):
...
def test_stop_processing_mapping_rules_once_first_one_is_met(service, backendservice, backend, updated_backend_mapping_rules_params, apicast_http_client):
